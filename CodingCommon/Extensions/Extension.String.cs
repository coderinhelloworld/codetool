...
namespace CodingCommon.Extentions
{
    public static partial class StringExtention
    {
        ...
        #region 命名规则
        /// <summary>
        /// 大写下划线连接,HELLO_MY_WORLD
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        public static string ToNamingUpperSnakeCase(this string input)
        {
            string sanitizedString = Regex.Replace(input, @"([a-z\d])([A-Z])", "$1_$2");
            sanitizedString = Regex.Replace(sanitizedString, @"[\W_]+", "_");
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public static string ToNamingLowerSnakeCase(this string input)
        {
            string sanitizedString = Regex.Replace(input, @"([a-z\d])([A-Z])", "$1_$2");
            sanitizedString = Regex.Replace(sanitizedString, @"[\W_]+", "_");
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public static string ToNamingTitleCase(this string input)
        {
            string sanitizedString = Regex.Replace(input, @"([a-z\d])([A-Z])", "$1_$2");
            sanitizedString = Regex.Replace(sanitizedString, @"[\W_]+", "_");
            var words = sanitizedString.Split("_");
            var stringbuilder = new StringBuilder();
            foreach (var str in words)
            {
                stringbuilder.Append(char.ToUpper(str[0]) + str.ToLower().Substring(1));
            }
        ...
        /// <summary>
        /// 首字母小写,其他首字母大写,helloMyWorld
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        public static string ToNamingCamelCase(this string input)
        {
            string sanitizedString = Regex.Replace(input, @"([a-z\d])([A-Z])", "$1_$2");
            sanitizedString = Regex.Replace(sanitizedString, @"[\W_]+", "_");
            var words = sanitizedString.Split("_");
            ...
            foreach (var str in words)
            {
                stringbuilder.Append((count++ > 0 ? char.ToUpper(str[0]) : char.ToLower(str[0])) + str.ToLower().Substring(1));
            }
            return stringbuilder.ToString();
        }
        ...
        /// <summary>
        /// 大写横线连接,HELLO-MY-WORLD
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        public static string ToNamingUpperKebabCase(this string input)
        {
            string sanitizedString = Regex.Replace(input, @"([a-z\d])([A-Z])", "$1_$2");
        ...
        /// <summary>
        /// 小写横线连接,hello-my-world
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        public static string ToNamingLowerKebabCase(this string input)
        {
            string sanitizedString = Regex.Replace(input, @"([a-z\d])([A-Z])", "$1_$2");
            sanitizedString = Regex.Replace(sanitizedString, @"[\W_]+", "-");
            return sanitizedString.ToLowerInvariant();
